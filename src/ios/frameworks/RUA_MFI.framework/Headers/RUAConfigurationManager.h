...
/**
 ...
 @param progress OnProgress block
 */
- (void)setSystemLanguage:(RUASystemLanguage)language progress: (OnProgress)progress response:(OnResponse)response;
 ...
 * @param response OnResponse block
 */
-(void)setApplicationSelectionFlag:(RUAApplicationSelectionOption)applicationSelectionOption response:(OnResponse)response;
